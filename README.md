...
~~~sh
# getting the code
git clone git@github.com:nko4/throw-42.git && cd ./throw-42/

# developing
npm install
npm start

# deploying (to http://throw-42.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@throw-42.2013.nodeknockout.com
ssh root@throw-42.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@throw-42.2013.nodeknockout.com
ssh -i ./id_deploy root@throw-42.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/throw-42" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
